...
export default function HelpDetailScreen() {
  ...
  const checkIfBookmarked = async () => {
    // Implement bookmark checking logic here
    // This is a placeholder - you'll need to implement your bookmark system
    setBookmarked(false);
  };
  ...
  const handleShare = async () => {
    ...
    try {
      const shareUrl = `https://uthutho.app/help/${topicId}`;
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        {/* Related Topics (You could fetch related topics here) */}
