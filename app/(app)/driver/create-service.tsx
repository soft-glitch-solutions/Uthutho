// app/(app)/driver/create-service.tsx
...
export default function CreateServiceScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Success!',
        'Transport service created successfully. It will be reviewed for verification.',
        [
          {
            text: 'OK',
    ...
    >
      <ScrollView style={styles.scrollContainer}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>New transport service</Text>
        </View>
        ...
        <View style={styles.formContainer}>
          ...
          <Text style={styles.note}>
            * Required fields
            ...
            {'\n\n'}
            By creating this service, you agree to provide safe and reliable transportation.
          </Text>
        </View>
      </ScrollView>
    </KeyboardAvoidingView>
